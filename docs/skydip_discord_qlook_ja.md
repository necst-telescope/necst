...
コードで表示し、数値マトリクスはMarkdown表として表示する。`tau`は値だけを表示し、
解析のエラーや品質フラグは`e_` prefix付きで`Error`列へ表示する。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| xffts-board1 | Band 6 USB | WARN | 0.308 | 29466.300 | 21578.300 | 8.750 | 5 | e_large_reduced_chi2 |
