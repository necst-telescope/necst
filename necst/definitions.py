...
class topic:
    ...
    local_attenuator = Topic(LocalAttenuator, "local_attenuator", qos.realtime, namespace.rx, True)
    local_attenuator_cmd = Topic(LocalAttenuator, "local_attenuator_cmd", qos.reliable, namespace.rx)
