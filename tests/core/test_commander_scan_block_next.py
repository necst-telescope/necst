...
def test_commander_scan_block_multiple_sections_and_all_kinds():
    ...
    sections = [
        DummySection(kind="initial_standby", start=(q(0.0), q(0.0)), stop=(q(1.0), q(0.0)), speed=q(0.5, "deg/s"), margin=q(0.1), label="A" * 80, line_index=0, tight=False),
        DummySection(kind="accelerate", start=(q(0.0), q(0.0)), stop=(q(1.0), q(0.0)), speed=q(0.5, "deg/s"), margin=q(0.1), label="acc", line_index=0, tight=False),
        DummySection(kind="line", start=(q(0.0), q(0.0)), stop=(q(1.0), q(0.0)), speed=q(0.5, "deg/s"), margin=q(0.1), label="line", line_index=0, tight=True),
        DummySection(kind="turn", start=(q(1.1), q(0.0)), stop=(q(-0.1), q(0.2)), speed=q(0.4, "deg/s"), label="turn", line_index=1, tight=False, turn_radius_hint=q(0.05)),
        DummySection(kind="final_decelerate", start=(q(0.0), q(0.2)), stop=(q(1.0), q(0.2)), speed=q(0.5, "deg/s"), margin=q(0.1), label="fin-dec", line_index=1, tight=False),
        DummySection(kind="final_standby", start=(q(1.1), q(0.2)), duration=q(2.5, "s"), speed=q(0.5, "deg/s"), label="final", line_index=1, tight=False),
    ]
